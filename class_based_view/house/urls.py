...
from .views import HomeView, HouseDetailView, HousingListView, HouseCreateView, HouseUpdateView, HouseDeleteView, delete_picture, UserLoginView, UserLogoutView
...
urlpatterns = [
  ...
  path('house_update/', HouseUpdateView.as_view(), name='house_update'),
